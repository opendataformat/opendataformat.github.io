...
(<a href="/files/profile.xml" download>profile.xml</a>), you can use the CESSDA
...
this repository (<a href="/files/metadata.xml" download>files/metadata.xml</a>) and
validate against the ODF profil
(<a href="/files/profile.xml" download>/files/profile.xml</a>). 
