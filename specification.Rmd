---
title: '<img src="images/odf icon.png" alt="Icon" style="height:100px; vertical-align: middle;"/> <span style="font-size: 60px; color: #156082; font-weight: bold; position: relative; top: 10px;">Open Data Format</span>'
...
# Specification of the Open Data Format (ODF)
...
<img src="images/img01.png" alt="Figure 2: Files of a dataset specified in the Open Data Format" style="margin-bottom: 20px;"><p style="text-align: right;">Figure 2: Files of a dataset specified in the Open Data Format</p>
...
this repository [metadata.xml](files/metadata.xml)) and
validate against the ODF profil
([profile.xml](files/profile.xml)). For further information on the 
metadata profile, see [Profile](profile.html).
