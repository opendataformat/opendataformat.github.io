...
You can download an example data file in the Open Data Format (<a href="/docs/files/example_dataset.zip" download>example_dataset.zip</a>). Manuals for generating data files in ODF can be found on 
