---
title: '<img src="images/odf icon.png" alt="Icon" style="height:100px; vertical-align: middle;"/> <span style="color: #156082; font-weight: bold; position: relative; top: 10px;">Open Data Format: Profile</span>'
output: html_document
---

------------------------------------------------------------------------

-   [Metadata Profile](#the-metadata-profile-of-the-open-data-format)
-   [ODF DDI Profiles](#odf-ddi-profile)
    -   [Mandatory Constraint](#mandatory-constraint)
    -   [Optional Constraint](#optional-constraint)
    -   [Mandatory if parent element is present Constraint](#mandatory-if-parent-element-is-present-constraint)
...
use the (<a href="/docs/files/profile.xml" download>XML profile</a>) from this repository and upload it,
together with your XML metadata file (<a href="/docs/files/metadata.xml" download>metadata.xml</a>) to the website of the [CESSDA
...
The <a href="/docs/files/profile.xml" download>DDI XML profile</a> of the ODF 
holds a set of constrains that use Xpath
...
the section [Complete Profile View](#complete-profile-view) or take a look at 
the XML profile CSV file.
