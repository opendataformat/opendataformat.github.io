...
use the (<a href="/files/profile.xml" download>XML profile</a>) from this repository and upload it,
together with your XML metadata file (<a href="/files/metadata.xml" download>metadata.xml</a>) to the website of the [CESSDA
...
The <a href="/files/profile.xml" download>DDI XML profile</a> of the ODF 
